...
##modules
    ...
    import tempfile
    #tempfile
        #manage temporary files and dirs
    ...
    ##wsgi
        ...
        #python interface for server communication
...
##modules
    ...
    #check where a module is located and if it is installed from python:
    ...
    #check where a module is located and if it is installed from bash:
...
##fileinput
    ...
    #this is an interface emulates the typical gnu interface
