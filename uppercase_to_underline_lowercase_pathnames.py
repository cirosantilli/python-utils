...
In addition, all the names of files and directories that have been renamed are serached inside
each file and updated to their new names.
'''
...
def uppercase_to_underline_lowercase_pathnames(path, extensions):
        ...
        if path_exists:
                ...
                #rename in all files
                #TODO: must replace larger names first
                replace_in_files.replace_in_files_full_tree(path,rename_dictionary,extensions)               
