...
#Hotstring * o
::gnm`;::Ciro				;- Given NaMe -;
::lnm`;::Santilli			;- Last name -;
::fnm`;::Duran Santilli			;- Family name -;
::cnm`;::Ciro Duran Santilli		;- Complete name -;
::cnmf`;::Ciro DURAN SANTILLI		;- French capital last name standard -;
::cnma`;::Ciro D. Santilli		;- Abbreviated (or American) dot middle name-;
::fgnm`;::Duran Santilli{Tab}Ciro{Tab}	;- family then given name for internet input-;

::bdt`;::14/05/1989
::bct`;::Rio Claro

;- address -;
::adr`;::10, boulevard des Maréchaux			;- address -;
::adrc`;::Bâtiment FOCH, Appartement 10.20.39	;- address complement -;
::pcd`;::91120						;- Postal CoDe -;
::city`;::Palaiseau					;- city -;
::cpc`;::Palaiseau, 91120						;- City Postal CoDe -;
::fadr`;::10, boulevard des Maréchaux{Tab}Bâtiment FOCH, Appartement{Tab}91120{Tab}Palaiseau	;- Full address for internet input-;

;- EP address -;

::epf`;::École Polytechnique	;- Ãƒâ€°cole Polytechnique (France) -;
::epadr`;::ECOLE POLYTECHNIQUE	;- address -;
::epadrc`;::Route de Saclay	;- address complement line 2 -;
::eppcd`;::91128			;- Postal CoDe -;
::epcity`;::PALAISEAU Cedex	;- city -;
::epfadr`;::ECOLE POLYTECHNIQUE{Tab}Route de Saclay{Tab}91128{Tab}PALAISEAU Cedex	    ;- Full address for internet input-;

;- contact -;
::mail`;::ciro.santilli@gmail.com	;- email -;
::tel`;::0169591651			;- fixed telephone -;

::cell`;::0658851651			;- cell phone -;
::tcell`;::ciro.santilli@gmail.com	;- cell phone -;
::ncs`;::Ciro D. Santilli`ncel: {+}33658851651`nskype: ciro.santilli		;- Name, Cell, Skype -;

;- social security France -;
::smerep`;::139205899			;- SMEREP number -;
::nss`;::1890599416120			;- numero de securite sociale -;
::ass`;::16 Bd. du General Leclerc - 92115 Clichy CEDEX		;- adress ss -;
::ssc`;::Vitale`rOrganisme: 99911061`rAdresse: 16 Bd. du General Leclerc - 92115 Clichy CEDEX`rNuméro de securité sociale: 189059941612087 ;- Complete ss -;

;- user pass -;
::unm`;::cirosantilli				;- standard User Name -;
::pwd`;::fgb4669201					;- cheap password -;
::pwdu`;::Fgb4669201				;- cheap password Upper case-;
::upwd`;::cirosantilli{Tab}fgb4669201{Enter}	;- user + password for quick internet input-;
::oid`;::https://plus.google.com/106598607405640635523/posts	;- Open ID-;
...
:*o:hstr`;::{:}{:}{:}{:}{Left 2}	    ;- Ahk hotstring -;
:*o:avar`;::{%}{%}{Left 1}		    ;- Ahk variable value -;
:*o:acm`;::{;}-  -{;}{Left 3}		    ;- Ahk comment -;
:*o:aln`;::;--  {- 60};{Home}{Right 4}	    ;- ahk line -;
:*o:ahln`;::;--  {- 30};{Home}{Right 4}	    ;- ahk half line -;
...
::pyrht\:: ;- python interpreter -;
    Run %python%\docs\Regex HOW TO.html
return
...
::itm\:: ;- Indian traditional music -;
    Run %share%\Music\Indian Traditional Music.wpl
return
...
;-- general ------------------------------------------------------------;
::op;::(,){Left 2}  ;- ordered pair -;
::ot;::(,,){Left 3}  ;- ordered triplet -;
::bp;::[,]{Left 2}  ;- bracket pair -;

;-- Java ------------------------------------------------------------;
::jpr`;::System.out.println()`;{Left 2}  ;- Java Pring -;
::jfi`;::for(int i=0; i<; i{+}{+}){{}`n`n{}}{Up 2}{End}{Left 7}  ;- Java For i -;
::jfij`;::for(int i=0; i<; i{+}{+}){{}`nfor(int j=0; j<; j{+}{+}){{}`n`n{}}`n{}}{Up 4}{End}{Left 7}  ;- Java For i -;
...
::prea;::<pre class="ahk"></pre>{Left 6} ;- to display autohotkey code -;
...
;comments
::hcm;::<{!}--  -->{Left 4}	;- Html CoMment -;
::habc;::<{!}--  -->{Left 4}<!--added by ciro --><!--/added by ciro -->
::todo;::<{!}--todo  -->{Left 4}
::todoe;::<{!}--todo type="example"  -->{Left 4}    ;- missing example -;
::todol;::<{!}--todo type="link"  -->	    ;- missing link -;
::todoi;::<{!}--todo type="incomplete"  --> ;- missing information -;
::todos;::<{!}--todo type="stub"  -->	    ;-  -;
...
::qi`;::\)  \({Left 3} ;- iq reversed. To cut up an eq. -;

;- math only: no document parts, identical in javascript mathematics with mathjax -;

;- Subscripts, superscripts -;
::sbs`;::{Backspace}{_}{{}{}}{Left 1} ;- SuBScript. Usage: first do a space, then und\. Otherwise cannot separate from last word. -;
...
::fdom`;::\funcDom{{}{}}{{}{}}{{}{}}{Left 5}
::comp`;::\comp \comp	;- composition of functions -;
...
::ddtattz`;::\derAt{{}{}}{{}t{}}{{}0{}}{Left 7}   ;- ddt at t equals -;
::ddtatto`;::\derAt{{}{}}{{}t{}}{{}1{}}{Left 7}
::ddx`;::\der{{}{}}{{}x{}}{Left 4}
::ddxatx`;::\derAt{{}{}}{{}x{}}{{}{}}{Left 6}
::ddxatxz`;::\derAt{{}{}}{{}x{}}{{}0{}}{Left 7}   ;- ddx at x equals -;
...
;matrix matrices
;;sets of matrices
::mn`;::\Mn ;-- define \Mn in latex to fix standard. for example, we could have either M(n) or M_n. A mixture of both would be intractable... --;
::gln`;::\GLn
::glnr`;::\GLn(\r)
::symn`;::\Symn
::spdn`;::\SPDn
...
;; matrix functions
::det`;::\det(){Left 1}
::trp`;::{Backspace}{^}{{}T{}} ;- SuBScript. Usage: first do a space, then und\. Otherwise cannot separate from last word. -;
::otrp`;::O{^}{{}T{}} ;- O transpose -;
::trc`;::\Tr(){Left 1}
::trclr`;::\Tr\left(\right){Left 7}
::pmtx;::\begin{{}pmatrix{}}`r`r\end{{}pmatrix{}}{Up}

;; other common notation
::lami`;::\lambda_i ;- eigen values -;
:R:bmodb`;::B^{-1}DB ;- diagonalization -;
:R:otr`;::O^{T} ;- traspose of an orthogonal matrix = to its inverse -;
:R:otdo`;::O^{T}DO ;- diagonalization of a symmetric matrix -;
...
::bul`;::\bullet			;- bullet -;
::bar`;::\bar{{}{}}{Left 1}		;- horizontal bar over -;
::oln`;::\overline{{}{}}{Left 1}	;- overline -;
::vec`;::\vec{{}{}}{Left 1}		;- vector sign -;
::top`;::\mathtop{{}{}}{{}{}}{Left 3}	;- mathTOP -;
::vecz`;::\vec{{}0{}}			;- vector Zero -;
::smns`;::\setminus			;- set minus -;
::cases`;::\begin{{}cases{}}`n &  \\`n &`n\end{{}cases{}}{Up 2}{Home} 		;- cases-;


::oi`;::],[{Left 2}	;- open interval -;
::ci`;::[,]{Left 2}	;- closed interval -;
::coi`;::[,[{Left 2}	;- closed open interval -;
::oci`;::],]{Left 2}	;- open closed interval -;
...
::ome`;::\omega
::omeo`;::\omega_1
:R:omeopt`;::\omega_1^2 	;- Pow Two -;
::omet`;::\omega_2
:R:ometpt`;::\omega_2^2	;- Pow Two -;
::Ome`;::\Omega
#Hotstring c0
...
:R:re`;::\mathbb{R}		;- REal numbers -;
:R:ren`;::\mathbb{R}^n		;- REal numbers -;
:R:res`;::\mathbb{R}		;- REal Star -;
:R:rep`;::\mathbb{R}_+		;- REal Plus -;
:R:remns`;::\mathbb{R}_-		;- REal Minus -;
:R:ire`;::\(\mathbb{R}\) 
:R:co`;::\mathbb{C}
...
::itmm`;::\begin{{}itemize{}}`r\item `r\item `r\end{{}itemize{}}{Up 2}{End}		;- ITeMMize -;
::desc`;::\begin{{}description{}}`r\item[]`r\item[]`r\end{{}description{}}{Up 2}{End}{Left}
:R:ali`;::\begin{align}`r`r\end{align}	    ;- equation align -;
...
::cexp`;::<div class="counter-example">`r<div class="cexp-title"></div>`r<div class="cexp-body">`r`r</div>`r</div>{Up 4}{End}{Left 6}	;- counter example -;
::rem`;::<div class="remark">`r<span class="rem-title"></span>`r<div class="rem-body">`r`r</div>`r</div>{Up 4}{End}{Left 6}		;- remark -;
...
::wexp`;::<blockquote><strong>Example</strong>`n</blockquote>{Up}{End}	;- example -;

::mth`;::<math></math>{Left 7}			;- equations -;

:R:wcn`;::{{Citation needed}}			;- citation needed -;
::wbf`;::''''{Left 2}				;- Bold Face -;
...
::pt`;::{Backspace}->	;- Dereference press then pt`; -;
::tsp;::this->		;- this with dereference -;
...
::ccm`;::// `			;- c Line Coment -;
::cbcm`;::/*  */{Left 3}	;- c block comment -;
::cln`;:://--  {- 60}//{Home}{Right 5}	    ;- ahk line -;
::chln`;:://--  {- 30}//{Home}{Right 5}	    ;- ahk half line -;
